...
@DisplayName ("18XX Saved Game Tests")
class SavedGameTest {
	SavedGame savedGame;
	...
	void SaveGameXMLGenerationTest  () {
		...
		assertEquals ("<Game gameID=\"2021-04-12-1315\" lastActionNumber=\"101\" players=\"SGPlayerAlpha, SGPlayerBeta, SGPlayerGamma\" status=\"Active\">",
