...
class ContractLineTests {
	...
	void isValidContractLineTests () {
		...
		assertEquals ("Bond Value is <= zero (0)", tContractLine.reasonInvalidContractLine ());

		tContractLine = new ContractLine (city, ShareCompany.NO_SHARE_COMPANY, 20);
		assertFalse (tContractLine.isValidContractLine ());
		assertEquals ("No Share Company is specified", tContractLine.reasonInvalidContractLine ());
		
		tContractLine = new ContractLine (City.NO_CITY, shareCompany, 30);
		assertFalse (tContractLine.isValidContractLine ());
		assertEquals ("No City is specified", tContractLine.reasonInvalidContractLine ());
