...
public enum MarketRegion {
	...
	MarketRegion (boolean aCloseCorporation, boolean aExceedPlayerCorpShareLimit, boolean aCountAgainstCertificateLimit,
			boolean aNotCountAsBuy, Color aColor, Color aTextColor) {
