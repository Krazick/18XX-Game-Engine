...
public class VariantEffect {
	...
	public static final AttributeName AN_ATTRIBUTE_NAME = new AttributeName ("attributeName");
	...
	public static final AttributeName AN_ACTION = new AttributeName ("action");
	public static final AttributeName AN_DEFAULT_EFFECT = new AttributeName ("defaultEffect");
	public static final AttributeName AN_NAME = new AttributeName ("name");
	public static final AttributeName AN_CELL_NAME = new AttributeName ("cellName");
	public static final AttributeName AN_CLASS = new AttributeName ("class");
	public static final AttributeName AN_HIDE = new AttributeName ("hide");
