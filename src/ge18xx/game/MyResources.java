...
public class MyResources extends ListResourceBundle {
	...
	static final Object [] [] contents = {
			...
			{ "message", "18xx Game Engine" }, { "showMapItem", "Show Map" }, { "showMarketItem", "Show Market" },
			{ "showCitiesItem", "Show City List" }, { "showTileTrayItem", "Show Tile Tray" },
			{ "showPrivatesItem", "Show Privates List" }, { "showCoalsItem", "Show Coal Companies List" },
			{ "showMinorsItem", "Show Minor Companies List" },
			{ "showShareCompaniesItem", "Show Share Companies List" }, { "showChatClientItem", "Show Chat Client" },
			...
			{ "GameSetXMLFile", "18xx Games.xml" }, { "version", "0.7.15a Beta" } };
}