...
public class TownTick extends Town {
	...
	public TownTick () {
		this (RevenueCenterType.NO_REVENUE_CENTER, NO_ID, Location.NO_LOCATION, NO_NAME, RevenueCenter.NO_VALUE, new TileType ());
	}
	...
	public TownTick (TownTick aTownTick) {
		this (aTownTick.type.getType (), aTownTick.id, aTownTick.location.getLocation (), 
				aTownTick.name, aTownTick.getRevenue (Revenue.ALL_PHASES), aTownTick.getTileType ());
