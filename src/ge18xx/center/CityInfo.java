...
public class CityInfo implements Cloneable {
	...
	public void drawDestination (Graphics g, int X1, int Y1, int aWidth, int aHeight, boolean aHome, Hex aHex) {
		...
		if (tTokenCompany != Corporation.NO_CORPORATION) {
			tTokenCompany.drawBase (g, X1, Y1, aWidth, aHeight, aHome, aHex);
		}
	}
	
	public void drawCorporationBase (Graphics g, int X1, int Y1, int aWidth, int aHeight, boolean aHome, Hex aHex) {
		TokenCompany tTokenCompany;
