...
public class TileName extends Feature implements Cloneable {
	...
	public static final String HH_NAME = "HH";
	...
	public boolean isXXTile () {
		boolean tIsXXTile;

		tIsXXTile = false;
		if (XX_NAME.equals (name)) {
			tIsXXTile = true;
		}
	...
	public boolean isHHTile () {
		boolean tIsHHTile;

		tIsHHTile = false;
		if (HH_NAME.equals (name)) {
			tIsHHTile = true;
		}
	...
	public boolean isYTile () {
		boolean tIsYTile;

		tIsYTile = false;
		if (Y_NAME.equals (name)) {
			tIsYTile = true;
		}
