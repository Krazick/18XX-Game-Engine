...
public class StartPacketItem implements ParsingRoutineI {
	...
	public boolean loadWithCertificates (Portfolio aBankPortfolio, Portfolio aStartPacketPortfolio) {
		...
		// Find the Certificate for the Private/Coal/Minor Corp and transfer from the Bank to the Start Packet
		// if there is a Free Certificate for a Share Corp, transfer that from the Bank to the Start Packet
	...
	void printStartPacketItemInfo () {
		...
		System.out.println ("  Corporation ID [" + corporationId + 
		...
		if (freeCertificateCorporationId > 0) {
			System.out.println ("      Free Certificate of [" + freeCertificateCorporationId +
							"] Percentage of [" + freeCertificateCorporationPercentage + "]");
