...
public class Action {
	...
	public static final AttributeName AN_TOTAL_CASH = new AttributeName ("totalCash");
	public static final AttributeName AN_CLASS = new AttributeName ("class");
	public static final AttributeName AN_NAME = new AttributeName ("name");
	public static final AttributeName AN_ROUND_TYPE = new AttributeName ("roundType");
	...
	public static final String NO_ROUND_ID = ">> NO ROUND ID <<";
	public static final String REPORT_PREFIX = "-";
	public static final String ACTION_NAME_SUFFIX = " Action";
