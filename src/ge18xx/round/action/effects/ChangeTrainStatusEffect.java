...
public class ChangeTrainStatusEffect extends Effect {
	...
	public String getEffectReport (RoundManager aRoundManager) {
		return (REPORT_PREFIX + name + " by " + actor.getName () + " for Trains Named " + trainName + 
				" of Order " + trainOrder + " from [" + Train.getNameOfStatus (oldTrainStatus) + 
				"] to [" + Train.getNameOfStatus (newTrainStatus) + "].");
	}
