...
//		System.out.println ("Parsing Escrow Old " + oldEscrow + " New " + newEscrow);
	...
	public String getEffectReport (RoundManager aRoundManager) {
		return (REPORT_PREFIX + name + " for " + actor.getName () + " from " + Bank.formatCash (oldEscrow) + 
				" to " +  Bank.formatCash (newEscrow) + ".");
	}
	...
	public boolean applyEffect (RoundManager aRoundManager) {
		...
		if (tEscrow != Escrow.NO_ESCROW) {
			...
			tEffectApplied = true;
			System.out.println ("=== Effect " + name + " Current Escrow Value Before " + tBefore + " After " + tEscrow.getCash ());
		} else {
