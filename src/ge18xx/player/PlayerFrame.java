...
public class PlayerFrame extends XMLFrame implements ItemListener {
	...
	public static final String STOCK_SELECTED_FOR_BID2 = "Another Private has been selected to Bid upon";
	public static final String CERTIFICATE_SELECTED_FOR_BUY = "A Certificate has been selected to Buy";
	public static final String CERTIFICATE_SELECTED_FOR_BUY2 = "Another Certificate has been selected to Buy";
	public static final String CERTIFICATE_SELECTED_FOR_SALE = "At least one Certificate has been selected to Sell";
	public static final String NO_CERTIFICATE_SELECTED_FOR_SALE = "No Certificates have been selected to Sell";
	public static final String NO_CERTIFICATE_SELECTED_FOR_SALE2 = "No Certificate have been selected to Buy or to Bid upon.";
	public static final String NO_CERTIFICATE_SELECTED_FOR_SALE3 = "No Certificate have been selected to Buy.";
	public static final String CERTIFICATE_SELECTED_FOR_EXCHANGE = "A President Share has been selected to Exchange";
	public static final String CERTIFICATE_SELECTED_FOR_BID = "A Private has been selected to Bid upon";
	public static final String PRIVATE_SELECTED_FOR_EXCHANGE = "A Private/Minor has been selected to Exchange";
	...
	public static final String WILL_OVERFILL = "Stocks selected to Sell will Overfill BankPool";
...
//	}
	...
	public void updateButtons () {
		...
		if (hasActed ()) {
			setDoneButton ();
			if (player.hasBoughtShare () || player.hasBid ()) {
