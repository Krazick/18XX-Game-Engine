...
public class EditCellAction extends TableAction {
    ...
    public EditCellAction(int aEditingColumn) {
        editingColumn = aEditingColumn;
    }
    ...
    protected void actionPerformed () {
        ...
        tInput = JOptionPane.showInputDialog (table, null, rowData.get (editingColumn));
        if (tInput != null)
            rowData.set (editingColumn, tInput);
