...
public class ButtonCellEditor extends AbstractCellEditor implements TableCellEditor
{
	...
	@Override
	public Component getTableCellEditorComponent (JTable aTable, Object aValue, boolean aIsSelected, 
			int aRow, int aColumn) {
        Action tAction;
        ActionEvent tEvent;
		
        tAction = (Action) aValue;
		tEvent = new ActionEvent (
                aTable, 
                ActionEvent.ACTION_PERFORMED, 
                aRow + TableAction.ROW_COLUMN_SEPARATOR + aColumn);
        tAction.actionPerformed (tEvent);
